...
class HardwareInterface{
	public:
		...
		/* only for debug real_trq and joint_trq_fbk*/
		...
		bool getJointTrq(int32_t* joint_trq);
		...
		// bool lambda_fct_callback = [](const Kinova::Api::Error &err, const k_api::BaseCyclic::Feedback data);
