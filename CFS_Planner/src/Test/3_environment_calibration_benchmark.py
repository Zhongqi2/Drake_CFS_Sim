...
TARGET = 'conveyor' # 'bagger' 'tool' 'conveyor'
TARGET_PCD = 'conveyor' # 'Bagging Machine' 'EPick' 'conveyor'
N_POS = 5 # num of camera positions
N_ANG = 5 # num of camera view angles
